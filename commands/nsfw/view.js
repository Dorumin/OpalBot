...
module.exports = (OpalBot) => {
    ...
    const sfw = ['tickle', 'meow', 'poke', 'kiss', '8ball', 'lizard', 'slap', 'cuddle', 'goose', 'avatar', 'fox_girl', 'hug', 'pat', 'smug', 'kemonomimi', 'holo', 'wallpaper', 'woof', 'baka', 'feed', 'neko', 'waifu', 'erofeet', 'eroyuri', 'gecg', 'holoero', 'gasm', 'ero', 'eron', 'erokemo'];
    const nsfw = [...sfw, 'femdom', 'classic', 'erok', 'les', 'hololewd', 'lewdk', 'keta', 'feetg', 'nsfw_neko_gif', 'kuni', 'tits', 'pussy_jpg', 'cum_jpg', 'pussy', 'lewdkemo', 'lewd', 'cum', 'spank', 'Random_hentai_gif', 'nsfw_avatar', 'boobs', 'feet', 'solog', 'bj', 'yuri', 'trap', 'anal', 'blowjob', 'hentai', 'futanari', 'solo', 'pwankg'];
